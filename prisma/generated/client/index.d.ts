...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'todo' | 'account' | 'session' | 'verificationToken' | 'user'
  ...
  interface AccountFieldRefs {
    ...
    readonly refresh_token_expires_at: FieldRef<"Account", 'Int'>
  ...
  export type AccountWhereInput = {
    ...
    refresh_token_expires_at?: IntNullableFilter<"Account"> | number | null
  ...
  export type AccountScalarWhereWithAggregatesInput = {
    ...
    refresh_token_expires_at?: IntNullableWithAggregatesFilter<"Account"> | number | null
  ...
  export type AccountUpdateInput = {
    ...
    refresh_token_expires_at?: NullableIntFieldUpdateOperationsInput | number | null
